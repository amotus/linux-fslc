/*
 * ov2311.h - ov2311 sensor mode tables
 *
...
#ifndef __ov2311_TABLES__
#define __ov2311_TABLES__

/*
 * Same value as in OV5640 used.
 * Should not be an issue but is worth suspecting.
 */
...
#define ov2311_TABLE_END	1
#define ov2311_WAIT_MS		10
#define ov2311_DEFAULT_MODE	0
 ...
 * format. There doesn't seem to be a way
 * to get this information from the sensor, though.
 */
#define ov2311_MAX_FORMAT_SUPPORTED	2

/*
 * TODO: Default fps set to the frame rate of VGA
 *
 * Need to check if it's ok
 */
#define ov2311_DEFAULT_FPS	60

#define ov2311_DEFAULT_DATAFMT	MEDIA_BUS_FMT_Y8_1X8
#define ov2311_DEFAULT_COLORSPACE V4L2_COLORSPACE_SRGB
...
struct ov2311 {
	 ...
	 * NOTE:
	 *
	 * New things added when porting to iMX8
	 */
